...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // Future<void> showUpdateNicknameDialog(
  ...
  //                     currentUser.uid, {'nickname': newNickname});
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: CircleAvatar(
                      radius:50,
                      backgroundImage:AssetImage("assets/image/vivin.jpg"),
                    ),
                  ),
                  SizedBox(height: 30),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //           255, 216, 114, 148), // Warna latar belakang
                        //       onPrimary: Colors.white, // Warna teks
                        //       textStyle:
                        //           TextStyle(fontSize: 20), // Ukuran teks
                        //     ),
                        //     onPressed: () async {
                        //       await showUpdateNicknameDialog(
